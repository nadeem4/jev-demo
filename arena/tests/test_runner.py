...
from arena.highway.runner import run_episode


def run(agent, **kw):
    return list(run_episode(agent, seed=0, **kw))


def test_starts_with_the_agent_seed_and_initial_frame():
...
def test_agent_failure_falls_back_to_idle_and_is_recorded():
    class Broken:
        name = "broken"
