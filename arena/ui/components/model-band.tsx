...
/** One model, whole: what it just played, its own board beneath, then the denser reading. */
export function ModelBand({ game, agent, view, board }: {
  ...
  return (
    <section className="border border-line bg-surface" aria-label={`${agent.name}: what it played, and its board`}>
      ...
      <figure className="grid justify-items-center gap-2 border-t border-line px-4 py-4">
        {board}
      ...
      {step && chosen && (
        <div className="border-t border-line px-4 py-4">
          ...
          <p className="mt-4 text-micro text-ink-soft">What it read before deciding</p>
